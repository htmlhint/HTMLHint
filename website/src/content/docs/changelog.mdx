...
## 2.0.0 _(2026-09-27)_

- <Badge text="Breaking" size="small" variant="danger" /> Node.js 22 or newer is now required
  [#1832](https://github.com/htmlhint/HTMLHint/pull/1832),
  [#1944](https://github.com/htmlhint/HTMLHint/pull/1944)
...
- <Badge text="Feat" size="small" /> Upgrade SARIF output support by updating `node-sarif-builder` to v4
  ...
  [#1865](https://github.com/htmlhint/HTMLHint/pull/1865)
...
- <Badge text="Fix" size="small" variant="danger" /> Improve [`attr-no-duplication`](/rules/attr-no-duplication/) and [`src-not-empty`](/rules/src-not-empty/) to compare tag and attribute names case insensitively
  [#1937](https://github.com/htmlhint/HTMLHint/pull/1937)
- <Badge text="Fix" size="small" variant="danger" /> Improve [`input-requires-label`](/rules/input-requires-label/) to allow inputs nested inside labels and warn when an implicit label has no visible text
  [#1852](https://github.com/htmlhint/HTMLHint/pull/1852),
  [#1864](https://github.com/htmlhint/HTMLHint/pull/1864)
- <Badge text="Fix" size="small" variant="danger" /> Improve [`title-require`](/rules/title-require/) to allow comments inside a non-empty `<title>`
  [#1938](https://github.com/htmlhint/HTMLHint/pull/1938)
- <Badge text="Docs" size="small" variant="tip" /> Refresh documentation, README, and website content, including the GitHub organization repos page, CLI docs fixes, and per-page last updated dates
  ...
  [#1861](https://github.com/htmlhint/HTMLHint/pull/1861),
  [#1863](https://github.com/htmlhint/HTMLHint/pull/1863),
  [#1940](https://github.com/htmlhint/HTMLHint/pull/1940)
- <Badge text="Chore" size="small" /> Refresh project tooling, linting, CI (including Node.js 26 in the test matrix), and dependencies
  [#1833](https://github.com/htmlhint/HTMLHint/pull/1833),
  [#1835](https://github.com/htmlhint/HTMLHint/pull/1835),
  ...
  [#1939](https://github.com/htmlhint/HTMLHint/pull/1939)

## 1.9.2 _(2026-03-05)_

- <Badge text="Fix" size="small" /> Dependencies update
  [#1817](https://github.com/htmlhint/HTMLHint/issues/1817)
