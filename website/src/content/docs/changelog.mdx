...
- <Badge text="Feat" size="small" /> New rule: [`button-type-require`](/rules/button-type-require/) The type attribute of a button element must be present with a valid value: “button”, “submit”, or “reset”.
