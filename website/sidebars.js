        ...
        Rules: [
          'user-guide/list-rules',
          {
            'Individual rules': [
              ...
              'user-guide/rules/attr-no-unnecessary-whitespace',
              'user-guide/rules/attr-sorted',
              'user-guide/rules/attr-unsafe-chars',
              'user-guide/rules/attr-value-double-quotes',
              'user-guide/rules/attr-value-not-empty',
              'user-guide/rules/attr-value-single-quotes',
              'user-guide/rules/attr-whitespace',
              'user-guide/rules/doctype-first',
              'user-guide/rules/doctype-html5',
              ...
              'user-guide/rules/input-requires-label',
              'user-guide/rules/script-disabled',
              ...
              'user-guide/rules/tag-self-close',
              'user-guide/rules/tagname-lowercase',
              'user-guide/rules/tagname-specialchars',
              'user-guide/rules/tags-check',
