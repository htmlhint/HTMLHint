...
var ruldId = 'src-not-empty-string',
    ruleOptions = {};
...
describe('Rules: '+ruldId, function(){
    ...
    it('Src be emtpy string should result in an error', function(){
    ...
    it('Src be non-empty string should not result in an error', function(){
